...
class DatabaseHelper(var context:Context): SQLiteOpenHelper(
    ...
    private val DROP_ACCOUNT_MENU = "DROP TABLE IF EXISTS $TABLE_MENU"
...
/*
    fun addMenu(model:MenuModel){
        ...
        val values = ContentValues()
        values.put(COLUMN_ID_MENU , model.id)
        values.put(COLUMN_NAMA_MENU, model.id)
        values.put(COLUMN_PRICE_MENU, model.id)
