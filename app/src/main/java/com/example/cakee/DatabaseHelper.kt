...
class DatabaseHelper(var context:Context): SQLiteOpenHelper(
    ...
    companion object {
        private val DATABASE_NAME = "cake"
    ...
    //CREATE MENU
    private val CREATE_MENU_TABLE = ("CREATE TABLE IF NOT EXISTS" + TABLE_MENU + "(" + COLUMN_ID_MENU + " INT PRIMARY KEY, " + COLUMN_NAMA_MENU + " TEXT, " + COLUMN_PRICE_MENU + " INT, " + COLUMN_IMAGE + " BLOB)")
    ...
    fun ShowMenu():ArrayList<menuModel>{
        ...
        if(cursor.moveToFirst()){
            do{
                ...
                val byteInputStreaam = ByteArrayInputStream(imageArray)
                imageBmp = BitmapFactory.decodeStream(byteInputStreaam)
