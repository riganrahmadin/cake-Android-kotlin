    ...
    inner class TransaksiViewHolder(v: View): RecyclerView.ViewHolder(v) {
        ...
        init {
            ...
            tambahQty.setOnClickListener {
                ...
                TransactionFragment.txtOrder.text = harga.toString()
                TransactionFragment.txtTax.text = (harga * 10 / 100).toString()
                TransactionFragment.txtTotal.text = (harga + (harga * 10 / 100)).toString()
            }
